...
Also read PLAN.md for the full architectural vision and CLAUDE.md for conventions.
...
- Clear priority order (dependencies first, then most important)
...
Tasks should be ordered so that foundational pieces come first:
...
- **DO reference the spec file** each task relates to
